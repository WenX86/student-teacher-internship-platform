...
import {
  scrollIntoView
} from "./chunk-QTTMLFB2.js";
import {
  flattedChildren
} from "./chunk-6AB6OCVK.js";
import {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [renderSlot(_ctx.$slots, "default", {}, () => [createBaseVNode("span", null, toDisplayString(_ctx.currentLabel), 1)])], 42, _hoisted_1)), [[vShow, _ctx.visible]]);
}
...
var useSelect = (props, emit) => {
  ...
  const { wrapperRef, isFocused, handleBlur } = useFocusController(inputRef, {
    ...
    afterBlur() {
      ...
      if (props.validateEvent) (_a = formItem == null ? void 0 : formItem.validate) == null ? void 0 : _a.call(formItem, "blur").catch((err) => debugWarn(err));
    }
  });
  ...
  watch(() => props.modelValue, (val, oldVal) => {
    ...
    setSelected();
    if (!isEqual_default(val, oldVal) && props.validateEvent) formItem == null ? void 0 : formItem.validate("change").catch((err) => debugWarn(err));
  }, {
    flush: "post",
    deep: true
  });
...
//# sourceMappingURL=chunk-TJXT34F3.js.map
