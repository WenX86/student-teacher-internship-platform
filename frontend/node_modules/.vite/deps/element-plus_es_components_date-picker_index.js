...
import {
  vRepeatClick
} from "./chunk-TXOTEGUU.js";
import {
  ElInput,
  useAttrs as useAttrs2
} from "./chunk-OTCOKZYV.js";
import {
  useFocusController
} from "./chunk-ORBTFOHB.js";
import {
  useAriaProps
...
import {
  castArray,
  extractFirst
} from "./chunk-Y7D5SGFH.js";
import "./chunk-P52OQJ3W.js";
import {
  ElButton
} from "./chunk-6G74LDAL.js";
import "./chunk-UDB25SCO.js";
import "./chunk-YIXCXJZL.js";
import "./chunk-EHPYJ4UX.js";
import {
  useEmptyValues,
  useEmptyValuesProps
} from "./chunk-F6ENHB5A.js";
import "./chunk-4ZODSA5D.js";
import "./chunk-VF2LR5F6.js";
import {
  ElIcon,
  arrow_down_default,
  arrow_left_default,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", { class: normalizeClass([
        ...
        createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body")) }, [
          ...
          createBaseVNode("div", { class: normalizeClass([[unref(ppNs).e("content"), unref(drpNs).e("content")], "is-left"]) }, [
          ...
          createBaseVNode("div", { class: normalizeClass([[unref(ppNs).e("content"), unref(drpNs).e("content")], "is-right"]) }, [
            createBaseVNode("div", { class: normalizeClass(unref(drpNs).e("header")) }, [
              _ctx.unlinkPanels ? (openBlock(), createElementBlock("button", {
                key: 0,
                type: "button",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", { class: normalizeClass(panelKls.value) }, [createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body-wrapper")) }, [
        ...
        createBaseVNode("div", { class: normalizeClass(unref(ppNs).e("body")) }, [createBaseVNode("div", { class: normalizeClass(leftPanelKls.value.content) }, [createBaseVNode("div", { class: normalizeClass(unref(drpNs).e("header")) }, [
          ...
          "onChangerange",
          "onSelect"
        ])], 2), createBaseVNode("div", { class: normalizeClass(rightPanelKls.value.content) }, [createBaseVNode("div", { class: normalizeClass(unref(drpNs).e("header")) }, [
          _ctx.unlinkPanels ? (openBlock(), createElementBlock("button", {
            key: 0,
            type: "button",
            disabled: !enableYearArrow.value || unref(yearRangeDisabled),
...
var date_picker_panel_default = defineComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    if (isUndefined(inject(PICKER_BASE_INJECTION_KEY, void 0))) provide(PICKER_BASE_INJECTION_KEY, { props: reactive({ ...toRefs(props) }) });
