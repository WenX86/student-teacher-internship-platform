import {
  ElScrollbar
} from "./chunk-BGW5RIQG.js";
import {
  ElTooltip,
  useTooltipContentProps
} from "./chunk-SRH7YQCN.js";
import {
  useAriaProps
} from "./chunk-HJ5ZPB7I.js";
import {
  rAF
} from "./chunk-UPY6HDDP.js";
import {
  _plugin_vue_export_helper_default
} from "./chunk-DANMHDNS.js";
import {
  CHANGE_EVENT,
  UPDATE_MODEL_EVENT
...
import {
  EVENT_CODE,
  getEventCode
} from "./chunk-ZT4S2KX5.js";
import "./chunk-Y7D5SGFH.js";
import {
  useDeprecated
} from "./chunk-YIXCXJZL.js";
import {
  useGlobalConfig
} from "./chunk-EHPYJ4UX.js";
import "./chunk-F6ENHB5A.js";
import "./chunk-4ZODSA5D.js";
import {
  ElIcon,
  arrow_down_default,
  arrow_right_default,
  arrow_up_default,
  loading_default
} from "./chunk-6SO3EEON.js";
import {
  useFormItem,
  useFormItemInputId
} from "./chunk-IO5U44PZ.js";
import {
  useFormDisabled,
  useFormSize
} from "./chunk-EU7K7GTN.js";
import {
  formContextKey
} from "./chunk-6QRLRGRY.js";
import {
  useSizeProp
} from "./chunk-7XEJKM6O.js";
import "./chunk-EB2ZWXKP.js";
import {
  useLocale
} from "./chunk-X5JVGM7Y.js";
import "./chunk-L4JARQ4W.js";
import {
  addClass,
  hasClass,
  isClient,
  ...
  useEventListener,
  useResizeObserver
} from "./chunk-WFQ3SR7W.js";
import {
  debugWarn,
  throwError
} from "./chunk-GOVEQYCR.js";
import {
  buildProps,
  definePropType,
  getProp,
  ...
  isPropAbsent,
  isUndefined
} from "./chunk-4A73VMWG.js";
import {
  withInstall,
  withNoopInstall
} from "./chunk-Z4USK4CA.js";
import {
  castArray_default,
  debounce_default,
  flatMap_default,
  ...
  const updateAllSelected = () => {
    ...
    const checkSelectedStatus = (data2) => {
      ...
      for (const row of data2) {
        ...
        rowIndex++;
        if (((_a3 = row[childrenColumnName.value]) == null ? void 0 : _a3.length) && !checkSelectedStatus(row[childrenColumnName.value])) return false;
      }
      return true;
    };
...
var useCheckboxEvent = (props, { model, isLimitExceeded, hasOwnLabel, isDisabled, isLabeledByFormItem }) => {
  ...
  watch(() => props.modelValue, () => {
    if (validateEvent.value) formItem == null ? void 0 : formItem.validate("change").catch((err) => debugWarn(err));
  });
  return {
    handleChange,
    onClickRoot
...
var checkbox_group_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    watch(() => props.modelValue, (newVal, oldValue) => {
      if (props.validateEvent && !isEqual_default(newVal, oldValue)) formItem == null ? void 0 : formItem.validate("change").catch((err) => debugWarn(err));
    });
    return (_ctx, _cache) => {
      var _a;
...
var table_vue_vue_type_script_lang_default = defineComponent({
  ...
  setup(props) {
    ...
    const { setCurrentRow, getSelectionRows, toggleRowSelection, clearSelection, clearFilter, toggleAllSelection, toggleRowExpansion, clearSort, sort, updateKeyChildren } = useUtils2(store);
...
function _sfc_render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 2), [[vShow, _ctx.resizeProxyVisible]])], 46, _hoisted_15);
}
var table_default = _plugin_vue_export_helper_default(table_vue_vue_type_script_lang_default, [["render", _sfc_render2]]);
