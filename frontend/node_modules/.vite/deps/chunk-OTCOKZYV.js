...
var input_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { wrapperRef, isFocused, handleFocus, handleBlur } = useFocusController(_ref, {
      ...
      afterBlur() {
        var _a;
        if (props.validateEvent) (_a = elFormItem == null ? void 0 : elFormItem.validate) == null ? void 0 : _a.call(elFormItem, "blur").catch((err) => debugWarn(err));
      }
    });
    ...
    watch(() => props.modelValue, () => {
      ...
      if (props.validateEvent) (_a = elFormItem == null ? void 0 : elFormItem.validate) == null ? void 0 : _a.call(elFormItem, "change").catch((err) => debugWarn(err));
    });
...
//# sourceMappingURL=chunk-OTCOKZYV.js.map
